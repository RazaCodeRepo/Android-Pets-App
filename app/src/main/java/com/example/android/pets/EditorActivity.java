...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void savePet(){
        ...
        if (mCurrentPetUri == null && TextUtils.isEmpty(petName) && TextUtils.isEmpty(petBreed) && TextUtils.isEmpty(petWeight) && mGender == PetsEntry.GENDER_UNKNOWN) {
        ...
        if(newRowId != -1){
            ...
            Toast.makeText(this, "Error with savng pet", Toast.LENGTH_LONG);
        }*/
        ...
        if(mCurrentPetUri == null){
            ...
            //Show a toast message depending on whether or not insertion was susccessful
            if(newUri == null){
                //If the new content URI is null, then there was error with the insertion
            ...
            case android.R.id.home:
              ...
              //Otherwise if there are unsaved changes, setup a dialog to warn the user.
                ...
                DialogInterface.OnClickListener discardButtonClickListener =
                        ...
                        //Show a dialog that notifies user they have unsaved changes.
